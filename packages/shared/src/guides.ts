...
/**
 * Workflow synthesis response from Gemini 2.5 Pro
 * Generated by the Omniscient Expert Collaborator during workflow creation
 */
export const WorkflowSynthesisResponseSchema = z.object({
  solution: z.string(), // High-level goal in natural language
  solutionExplanation: z.string(), // WHY this approach makes sense
  supportingDataExplanation: z.string(), // HOW search results support solution
  stepList: z.array(StepSchema), // Ordered list of actionable steps
});

export type WorkflowSynthesisResponse = z.infer<typeof WorkflowSynthesisResponseSchema>;
