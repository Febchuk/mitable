...
import slackUserEventsRouter from "./domains/integrations/slack/slack-user-events.routes.js";
...
import inferenceRouter from "./domains/auth/routes/inference.js";
...
router.use("/integrations/slack", slackUserEventsRouter);
