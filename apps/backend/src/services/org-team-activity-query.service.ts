/**
 * Org-scoped team activity queries (daily metrics, members, session summaries).
 * Used by in-app Agent Layer 1 (admin tools) and thin legacy wrappers only.
...
export class OrgTeamActivityQueryService {
