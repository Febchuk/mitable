...
import { type MockupColors, type MockupVariant, getMockupColors } from "./mockups/colors";
    ...
    return (
        <div
            ...
            style={{
                ...
                background: active ? `rgba(${C.accentRgb}, 0.08)` : hovered ? hoverBg : "transparent",
                                            ...
                                            {DROPDOWN_OPTIONS.map((option) => (
                                                <div
                                                    ...
                                                    style={{
                                                        ...
                                                        background: option === frame.status ? dropdownHover : "transparent",
                                                        cursor: "pointer",
                                                    }}
                                                >
                                                    {option}
...
const BarRow = ({ label, pct, time, barVariant = "default", C }: { label: string; pct: number; time: string; barVariant?: BarVariant; C: MockupColors }) => {
    const v =
        barVariant === "hero"
            ? {
                  gap: 12,
