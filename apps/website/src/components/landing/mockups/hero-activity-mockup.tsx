    ...
    <div style={{ display: "flex", height: 400, fontFamily: C.sans }}>
        ...
        >
            ...
            <div style={{ marginTop: "auto" }}>
                <div style={{ padding: "6px 14px", fontSize: 11, color: C.textMuted }}>
        ...
        <div style={{ flex: 1, background: C.bg, overflowY: "auto", padding: "14px 18px" }}>
            ...
            {/* Day header */}
            <div style={{ fontFamily: C.serif, fontSize: 18, fontWeight: 400, color: C.text, marginBottom: 4 }}>
                Wednesday, March 25
            </div>
            <div style={{ fontSize: 11, color: C.accent, marginBottom: 16, fontStyle: "italic" }}>
                4h 38m recorded
            </div>
            ...
            >
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 4, marginBottom: 14 }}>
                    ...
                    <div>
                        ...
                        >
                            Researched how to deactivate users from Slack as an admin. Used Claude to find the
                            process for completing the offboarding started in Google&apos;s Admin dashboard.
                        </div>
                    </div>
