...
export default function EvaluationsPost() {
    return (
        <BlogPostLayout title={post.title} description={post.description} publishedAt={post.publishedAt}>
            ...
            <ol>
                <li><strong>Data Aggregation:</strong> We pull the "master stories" generated by our Workstream RLM.</li>
                <li><strong>Benchmark Comparison:</strong> We run these stories against the specific benchmarks defined for that employee's role.</li>
                <li><strong>Semantic Scoring:</strong> Using our hybrid search system (PostgreSQL FTS + Pinecone), we pull similar past work to ensure scoring consistency.</li>
            ...
            <blockquote>
                "A score without context is just a grade. A score with context is a path to improvement."
            </blockquote>
