...
>(({ className, ...props }, ref) => (
  <ToastPrimitive.Root
    ref={ref}
    className={cn("rounded-md border border-ink/10 bg-canvas p-4 text-sm shadow-md", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <ToastPrimitive.Description ref={ref} className={cn("text-ink/60", className)} {...props} />
));
