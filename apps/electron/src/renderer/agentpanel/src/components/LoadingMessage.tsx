...
export default function LoadingMessage({ message }: LoadingMessageProps) {
  return (
    <div className="loading-message flex items-start gap-3 py-2">
      ...
      <div
        className="loading-text animate-gradient bg-gradient-to-r from-gray-400 via-white to-gray-400 bg-[length:200%_auto] bg-clip-text text-transparent text-sm font-medium"
        style={{
