...
export default function ExpertsCard({ experts, suggestedNudge, conversationId }: ExpertsCardProps) {
  ...
  return (
    <div className="bg-background-secondary rounded-lg p-4 space-y-3">
      <h3 className="text-text-primary font-semibold text-sm">💬 Experts who can help:</h3>
      ...
      {suggestedNudge && (
        <div className="text-xs text-text-tertiary pt-2 border-t border-border-subtle">
          <p className="italic">Pre-filled context available based on your conversation</p>
        </div>
      )}
    </div>
  );
