    ...
    >
      ...
      <div className="flex-shrink-0 p-2 space-y-1 border-t border-border-subtle">
        ...
        >
          ...
          {open && <span className="text-nav-item group-hover:text-white transition-colors">Notifications</span>}
        </button>
        <button
          className="group flex items-center gap-3 w-full px-3 py-2 rounded-lg hover:bg-white/10 transition-all duration-200"
          title="Settings"
        >
          ...
          {open && <span className="text-nav-item group-hover:text-white transition-colors">Settings</span>}
        </button>
        <button
