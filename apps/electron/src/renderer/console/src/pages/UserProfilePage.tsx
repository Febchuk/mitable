...
import AgentSkillsTab from "../components/views/employee/AgentSkillsTab";
...
export default function UserProfilePage() {
  ...
  const tabs = [
    ...
    { id: "agent" as const, label: "Agent Skills", icon: MitableIcon },
    ...
    <div style={{ flex: 1, display: "flex", overflow: "hidden" }}>
      ...
      <div style={{ flex: 1, overflowY: "auto" }}>
        <div style={{ maxWidth: 640, padding: "28px 36px" }}>
          ...
          {/* Agent Tab */}
          {activeTab === "agent" && <AgentSkillsTab />}
