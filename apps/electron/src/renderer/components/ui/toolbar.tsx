...
function withTooltip<T extends React.ComponentType<any>>(Component: T) {
  return React.forwardRef<any, TooltipProps<T>>(function ExtendComponent(
    ...
    // @ts-expect-error - Complex generic type inference limitation with forwardRef
