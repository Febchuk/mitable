...
>(({ className, ...props }, ref) => (
    <TabsPrimitive.List
        ref={ref}
        className={cn(
            "inline-flex h-9 items-center justify-center rounded-lg bg-canvas-raised border border-stroke-subtle p-1 text-ink-secondary",
            className
        )}
        {...props}
    />
