...
export default function ClassroomsPage() {
    const { classrooms, teachers, updateClassroom, addClassroom, assignTeacherToClassroom } = useStore();
    ...
    const [form, setForm] = React.useState<{
        ...
        ageRange: string;
        teacherId: string;
    }>({ name: "", level: "primary", ageRange: "", teacherId: teachers[0]?.id ?? "" });
                    ...
                    return (
                        <Card key={c.id}>
                            <CardContent className="p-4 space-y-2">
                                ...
                                <div className="text-sm text-ink-secondary">
                                    {c.studentIds.length} students · ages {c.ageRange}
                                </div>
                                <div className="pt-2">
